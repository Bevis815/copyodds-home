export function IconGitHub({ className = 'size-4' }) {
  return (
...
export function IconX({ className = 'size-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export function IconDiscord({ className = 'size-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export function IconBook({ className = 'size-4' }) {
  return (
...
export function IconApi({ className = 'size-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function IconBlog({ className = 'size-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function IconStar({ className = 'size-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M12 2.25l2.927 5.93 6.548.953-4.738 4.617 1.118 6.52L12 17.27l-5.855 3 1.118-6.52L2.525 9.133l6.548-.953L12 2.25z" />
    </svg>
  )
}

export function IconArrowRight({ className = 'size-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function IconExternal({ className = 'size-3.5' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function IconSpinner({ className = 'size-4' }) {
  return (
